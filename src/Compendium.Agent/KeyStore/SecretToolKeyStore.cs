...
{
    private const string Service = "compendium";
    private const string Account = "llm-api-key";
    ...
    {
        var psi = new ProcessStartInfo("secret-tool", $"store --label \"Compendium API key\" service {Service} account {Account}")
        {
